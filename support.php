...
<body>
    <div class="wrapper">
        ...
        <section class="content__support _container _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Поддержка</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Поддержка</div>
            <div class="text-mon48__bold _color-gradient display__none display__none320 display-flex800">Поддержка</div>
            <div class="block-text__support">
                <div class="text-arrow">
                    <div class="text-mon15__reg display__none display__none800">Не продлевается подписка/Не проходит оплата за контент</div>
                    <div class="text-mon20__reg  display__none320 display__flex  display__none800">Не продлевается подписка/Не проходит оплата за контент</div>
                    <div class="text-mon32__reg display__none display__none320 display-flex800">Не продлевается подписка/Не проходит оплата за контент</div>
                    <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.70711 8.70711C8.31658 9.09763 7.68342 9.09763 7.29289 8.70711L0.928932 2.34315C0.538408 1.95262 0.538408 1.31946 0.928932 0.928932C1.31946 0.538408 1.95262 0.538408 2.34315 0.928932L8 6.58579L13.6569 0.928932C14.0474 0.538408 14.6805 0.538408 15.0711 0.928932C15.4616 1.31946 15.4616 1.95262 15.0711 2.34315L8.70711 8.70711ZM9 7V8H7V7H9Z" fill="#E3311D" />
                    </svg>
                </div>
                <div class="text-arrow">
                    <div class="text-mon15__reg display__none display__none800">Что такое подписка и зачем она нужна?</div>
                    <div class="text-mon20__reg display__none320 display__flex display__none800">Что такое подписка и зачем она нужна?</div>
                    <div class="text-mon32__reg display__none display__none320 display-flex800">Что такое подписка и зачем она нужна?</div>
                    <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.70711 8.70711C8.31658 9.09763 7.68342 9.09763 7.29289 8.70711L0.928932 2.34315C0.538408 1.95262 0.538408 1.31946 0.928932 0.928932C1.31946 0.538408 1.95262 0.538408 2.34315 0.928932L8 6.58579L13.6569 0.928932C14.0474 0.538408 14.6805 0.538408 15.0711 0.928932C15.4616 1.31946 15.4616 1.95262 15.0711 2.34315L8.70711 8.70711ZM9 7V8H7V7H9Z" fill="#E3311D" />
                    </svg>
                </div>
                <div class="text-arrow">
                    <div class="text-mon15__reg display__none display__none800">Как определить свой логин и где найти UID учетной записи</div>
                    <div class="text-mon20__reg display__none320 display__flex display__none800">Как определить свой логин и где найти UID учетной записи</div>
                    <div class="text-mon32__reg display__none display__none320 display-flex800">Как определить свой логин и где найти UID учетной записи</div>
                    <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.70711 8.70711C8.31658 9.09763 7.68342 9.09763 7.29289 8.70711L0.928932 2.34315C0.538408 1.95262 0.538408 1.31946 0.928932 0.928932C1.31946 0.538408 1.95262 0.538408 2.34315 0.928932L8 6.58579L13.6569 0.928932C14.0474 0.538408 14.6805 0.538408 15.0711 0.928932C15.4616 1.31946 15.4616 1.95262 15.0711 2.34315L8.70711 8.70711ZM9 7V8H7V7H9Z" fill="#E3311D" />
                    </svg>
                </div>
                <div class="text-arrow">
                    <div class="text-mon15__reg display__none display__none800">Почему некоторые «старые» фильмы надо покупать?</div>
                    <div class="text-mon20__reg display__none320 display__flex display__none800">Почему некоторые «старые» фильмы надо покупать?</div>
                    <div class="text-mon32__reg display__none display__none320 display-flex800">Почему некоторые «старые» фильмы надо покупать?</div>
                    <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.70711 8.70711C8.31658 9.09763 7.68342 9.09763 7.29289 8.70711L0.928932 2.34315C0.538408 1.95262 0.538408 1.31946 0.928932 0.928932C1.31946 0.538408 1.95262 0.538408 2.34315 0.928932L8 6.58579L13.6569 0.928932C14.0474 0.538408 14.6805 0.538408 15.0711 0.928932C15.4616 1.31946 15.4616 1.95262 15.0711 2.34315L8.70711 8.70711ZM9 7V8H7V7H9Z" fill="#E3311D" />
                    </svg>
                </div>
                <div class="text-arrow">
                    <div class="text-mon15__reg display__none display__none800">Почему фильмы на Иви нельзя смотреть совсем бесплатно?</div>
                    <div class="text-mon20__reg display__none320 display__flex display__none800">Почему фильмы на Иви нельзя смотреть совсем бесплатно?</div>
                    <div class="text-mon32__reg display__none display__none320 display-flex800">Почему фильмы на Иви нельзя смотреть совсем бесплатно?</div>
                    <svg width="16" height="9" viewBox="0 0 16 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.70711 8.70711C8.31658 9.09763 7.68342 9.09763 7.29289 8.70711L0.928932 2.34315C0.538408 1.95262 0.538408 1.31946 0.928932 0.928932C1.31946 0.538408 1.95262 0.538408 2.34315 0.928932L8 6.58579L13.6569 0.928932C14.0474 0.538408 14.6805 0.538408 15.0711 0.928932C15.4616 1.31946 15.4616 1.95262 15.0711 2.34315L8.70711 8.70711ZM9 7V8H7V7H9Z" fill="#E3311D" />
                    </svg>
                </div>
            </div>
            <button class="btn__support __margin-top15">
                <div class="text-mon15__bold display__none display__none800">Написать в поддержку</div>
                <div class="text-mon20__bold display__none320 display__flex _color-white">Написать в поддержку</div>
            </button>
        </section>
        <div class="line _container768 _container1200"></div>
