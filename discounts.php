    ...
    <div class="wrapper">
        ...
        <section class="content1 _container _container768 _container1200">
            <div class="block_text_index">
                <div class="text-mon20__bold display__none display__none800">Кино дома и
                    <br>в дороге</div>
                <div class="text-mon28__bold display__none320 display__flex display__none800">Кино дома и
                    <br>в дороге</div>
                <div class="text-mon64__bold display__none display__none320 ">Кино дома и
                    <br>в дороге</div>
                <div class="text-mon10__reg __margin-top5 display__none display__none800">Начните на телевизоре и продолжите с того же места 
                    <br>на смартфоне или планшете, онлайн или без интернета. 
                    <br>Ваша история просмотров всегда под рукой</div>
                <div class="text-mon12__reg __margin-top5 display__none320 display__flex display__none800">Начните на телевизоре и продолжите с того же места 
                    <br>на смартфоне или планшете, онлайн или без интернета. 
                    <br>Ваша история просмотров всегда под рукой</div>
                <div class="text-mon22__reg __margin-top5 display__none display__none320 display-flex800">Начните на телевизоре и продолжите с того же места 
                    <br>на смартфоне или планшете, онлайн или без интернета. 
                    <br>Ваша история просмотров всегда под рукой</div>
            ...
            <div class="images_discounts"></div>
        </section>
        <section class="content2__search _container _container768 _container1200">
            <div class="text-mon20__bold _color-gradient">СКИДКИ</div>
            <div class="block-images__search">
                <div class="images-btn__discounts">
                    <div class="images__search"></div>
                    <button class="btn__discounts">
                        <div class="text-mon15__bold">Купить сейчас</div>
                    </button>
                </div>
                <div class="images-btn__discounts">
