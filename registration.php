...
<body>
    <div class="wrapper">
        ...
        <section class="content__support _container _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Регистрация</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Регистрация</div>
            <div class="text-mon48__bold _color-gradient display__none display__none320 display-flex800">Регистрация</div>
            <form class="block-text__support _gap30"  action="assets/php/save_users.php" method="POST">
                ...
                <div class="input-container ic2">
                    <input name="number" id="number" class="input" type="tel" placeholder=" " required/>
                    <div class="cut"></div>
                    <label for="number" class="placeholder">Phone number</label>
                </div>
                ...
                <div class="input-container ic5">
                    <input name="confirm_password" id="confirm_password" class="input" type="password" placeholder=" " required/>
                    <div class="cut cut-short"></div>
                    <label for="confirm_password" class="placeholder">Confirm password</label>
                </div>
                <button  class="btn__support __margin-top15" type="submit">
                <div  class="text-mon15__bold display__none display__none800">Зарегистрироваться</div>
                <div  class="text-mon20__bold display__none320 display__flex _color-white">Зарегистрироваться</div>
            </button>
            </form>
        </section>
        <div class="line _container768 _container1200"></div>
