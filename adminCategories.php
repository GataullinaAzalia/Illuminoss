...
<body>
    <div class="wrapper">
        ...
        <section class="content__support _container _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Добавление жанра</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Добавление жанра</div>
            <div class="text-mon48__bold _color-gradient display__none display__none320 display-flex800">Добавление жанра</div>
            <form class="block-text__support _gap30"  action="assets/php/add_categories.php" method="POST">
                <div class="input-container ic1">
                    <input class="input" type="text" name="name" placeholder="Название жанра" required/>
                </div>
             <button class="btn__support __margin-top15 _w0" type="submit">
                <div class="text-mon15__bold display__none display__none800 ">Добавить жанр</div>
                <div class="text-mon20__bold display__none320 display__flex _color-white">Добавить жанр</div>
            </button>
            </form>
