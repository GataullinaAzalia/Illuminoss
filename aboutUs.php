...
<body>
    <div class="wrapper">
        ...
        <section class="content1__aboutus _container _container768 _container1200">
            <div class="block-text__aboutUs">
                <div class="text-mon20__bold display__none display__none800">ТОП-3 среди онлайн-
                    <br>кинотеатров в РФ*</div>
                <div class="text-mon28__bold display__none320 display__flex  display__none800">ТОП-3 среди онлайн-
                    <br>кинотеатров в РФ*</div>
                <div class="text-mon64__bold display__none display__none320 display-flex800">ТОП-3 среди онлайн-
                    <br>кинотеатров в РФ*</div>
                <div class="line"></div>
                <div class="block__advantages">
                    <div class="advantages1">
                        <div class="text-mon13__bold  display__none display__none800">40+ млн</div>
                        <div class="text-mon24__bold display__none320 display__flex  display__none800 _color-grey">40+ млн</div>
                        <div class="text-mon48__bold display__none display__none320 display-flex800">40+ млн</div>
                        <div class="text-mon10__reg display__none display__none800">уникальных пользователей в месяц</div>
                        <div class="text-mon12__reg display__none320 display__flex  display__none800">уникальных пользователей в месяц</div>
                        <div class="text-mon24__reg display__none display__none320 display-flex800">уникальных пользователей в месяц</div>
                    </div>
                    <div class="advantages1">
                        <div class="text-mon13__bold display__none display__none800">2.6 млрд часов</div>
                        <div class="text-mon24__bold display__none320 display__flex  display__none800 _color-grey">2.6 млрд часов</div>
                        <div class="text-mon48__bold display__none display__none320 display-flex800">2.6 млрд часов</div>
                        <div class="text-mon10__reg display__none display__none800">общая длительность смотрения за год</div>
                        <div class="text-mon12__reg display__none320 display__flex  display__none800">общая длительность смотрения за год</div>
                        <div class="text-mon24__reg display__none display__none320 display-flex800">общая длительность смотрения за год</div>
                    </div>
                </div>
            </div>
        </section>
        <section class="content2__aboutus _container _container768 _container1200">
            <div class="text-mon20__bold _color-gradient display__none display__none800">Технологии</div>
            <div class="text-mon24__bold _color-gradient display__none320 display__flex  display__none800">Технологии</div>
            <div class="text-mon32__bold _color-gradient display__none display__none320 display-flex800">Технологии</div>
            <div class="block-card__aboutus">
                <div class="card__aboutus">
                    <svg width="46" height="41" viewBox="0 0 46 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M35 40H22.5H10" stroke="#7C8685" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M22.5 40V30" stroke="#7C8685" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M22.5 30H0V0H45V30H22.5Z" stroke="#7C8685" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                    <div class="text-mon15__reg display__none display__none800">Сервис доступен на любой платформе и еженедельно обновляется</div>
                    <div class="text-mon24__reg display__none320 display__flex">Сервис доступен на любой платформе и еженедельно обновляется</div>
                </div>
                <div class="card__aboutus">
                    <svg width="46" height="41" viewBox="0 0 46 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M35 40H22.5H10" stroke="#7C8685" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        ...
        <section class="content2__search _container _container768 _container1200">
            <div class="text-mon20__bold _color-gradient display__none display__none800">Карьера</div>
            <div class="text-mon24__bold _color-gradient display__none320 display__flex  display__none800">Карьера</div>
            <div class="text-mon32__bold _color-gradient display__none display__none320 display-flex800">Карьера</div>
            <div class="images12__aboutus">
                <div class="images1_aboutus"></div>
                <div class="images2_aboutus"></div>
            </div>
        </section>
        <div class="line _container768 _container1200"></div>
