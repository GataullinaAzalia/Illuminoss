<?php
    ...
    $genres = $my_sql->query("SELECT * FROM `genres` WHERE id = '$genre_id'");
...
<body>
    <div class="wrapper">
        ...
        <section class="content__support _container _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Изменение жанра</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Изменение жанра</div>
            <div class="text-mon48__bold _color-gradient display__none display__none320 display-flex800">Изменение жанра</div>
            <form class="block-text__support _gap30"  action="assets/php/update_categories.php"  method="POST" enctype="multipart/form-data">
                <div class="input-container ic1">
                    <input type="hidden" name="id" value="<?= $genre['id'] ?>">
                    <input class="input" type="text" name="name" placeholder="Название жанра"  value="<?= $genre['name'] ?>" required/>
                </div>
            ...
            <div class="block-card__aboutus">
                <table  id="output-categories" style="width: 800px;  margin: 0 auto;">
                    ...
                    <tr>
                        <th><?= $genre['id'] ?></th>
                        <th><?= $genre['name'] ?></th>
                        <th><a href="adminEditCategories.php?id=<?= $genre["id"] ?>"><button class="table-btn__update">Изменить<br>жанр</button></a></th>
                        <th><a href="assets/php/delete.php?id=<?= $genre["id"] ?>&action=genres"><button class="table-btn__delete">Удалить<br>жанр</button></a></th>
                    </tr>
                    <?php
                        }
                    ?>
