...
<body>
    <div class="wrapper">
            ...
            <div class="header__content">
                ...
                <div class="icon-header__index display__none320 display__flex">
                    ...
                    <div class="icon1-text__index">
                        ...
                        <a class="text-mon18__bold" href="authorization.php">
                            <?php
                                $role = "Войти";
                                if ($_SESSION['role'] == "admin") {
                                    echo str_replace("Войти","Админ",$role);
                                }
                                if($_SESSION['role'] == "user"){
                                    echo str_replace("Войти","Пользователь",$role);
                                }
                            ?>
                        </a>
                    </div>
        ...
        <section class="content1__subscription _container _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Аккаунт</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Аккаунт</div>
            <div class="text-mon48__bold _color-gradient  display__none display__none320 display-flex800">Аккаунт</div>
            <div class="text-mon20__bold display__none display__none800">Номер:
                <br>Пароль:
            </div>
            <div class="text-mon32__bold display__none320 display__flex _color-grey-dark">
                <?php
                    $users = mysqli_query($my_sql, query: "SELECT * FROM `users` WHERE `number` = '".$_SESSION['number']."'");
        ...
        <?php
            if($_SESSION['role'] == "admin") {
                ?>
        <section class="content1__ _container _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Добавить</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Добавить
            </div>
            <div class="text-mon48__bold _color-gradient  display__none display__none320 display-flex800">Добавить</div>
            <section class="content1 content3__index _container _container768 _container1200 _just-ar">
                <a href="adminProducts.php">
                    <button class="btn__index">
                        <div class="text-mon15__bold display__none800">Фильм или сериал</div>
                        <div class="text-mon20__bold _color-white display__none  display__none320 display-flex800">Фильм
                            или сериал</div>
                    </button>
                </a>
                <a href="adminCategories.php">
                    <button class="btn__index">
                        <div class="text-mon15__bold display__none800">Жанр</div>
                        <div class="text-mon20__bold _color-white display__none  display__none320 display-flex800">Жанр
                        </div>
                    </button>
                </a>
            </section>
        ...
        <section class="content2__search _container _container768 _container1200">
            <div class="block-content__subscription">
                <div class="card-content__subscription">
                    <div class="images_subscription"></div>
                    <div class="content-text__subscription">
                        <div class="text-mon20__bold display__none display__none800">Retflix </div>
                        <div class="text-mon24__bold display__none320 display__flex _color-grey-dark">Retflix </div>
                        <div class="text-mon12__reg __margin-top5 display__none display__none800">Для мобильного
                            приложения. Полный каталог
                            <br>без ограничений. Может смотреть 1 человек
                        </div>
                        <div class="text-mon14__reg __margin-top5 display__none320 display__flex">Для мобильного
                            приложения. Полный каталог
                            <br>без ограничений. Может смотреть 1 человек
                        </div>
                        <div class="categories__subscript display__none320 display__flex  ">
                            <div class="categories1__subscript">
                                <div class="text-mon11__bold"> Фильмы</div>
                            </div>
                            <div class="categories1__subscript">
                                <div class="text-mon11__bold"> Сериалы</div>
                            </div>
                            <div class="categories1__subscript">
                                <div class="text-mon11__bold"> Новинки</div>
                            </div>
                        </div>
                        <a href="oplata.php">
                        <button class="btn__subscription __margin-top45 ">
                            <div class="text-mon10__bold display__none display__none800">Подключить за 99 р./ месяц
                            </div>
                            <div class="text-mon16__bold display__none320 display__flex _color-white">Подключить за 99
                                р./ месяц</div>
                        </button>
                        </a>
                    </div>
        ...
        <section class="content3__descriptionFilm _container768 _container1200 _js-center">
            <a href="assets/php/exit.php ">
                <button class="btn__index">
                    <div class="text-mon15__bold display__none800">Выйти</div>
                    <div class="text-mon20__bold _color-white display__none  display__none320 display-flex800">Выйти
                    </div>
                </button>
            </a>
        </section>
