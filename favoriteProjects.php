...
<body>
    <div class="wrapper">
        ...
        <section class="content1__search _container _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">История просмотра</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">История просмотра</div>
            <div class="text-mon48__bold _color-gradient display__none display__none320 display-flex800">История просмотра</div>
            <div class="block-images__search">
                <div class="images-text__favoriteProjects">
                    <div class="images__search"></div>
                    <div class="images-text__favoriteProjects">
                        <div class="block-text__favoriteProjects">
                            <div class="text-mon20__bold _color-gradient">Дата просмотра:</div>
                            <div class="text-mon20__medium">01.01.2001</div>
                        </div>
                        <div class="icon__favoriteProjects">
                            <svg width="25" height="23" viewBox="0 0 25 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M7.1 0.901081C4.97 0.901081 3.15833 1.66608 1.88833 3.06108C0.63 4.44108 0 6.33108 0 8.42275C0 12.0561 1.85 14.9511 4.2 17.2027C6.54 19.4444 9.48333 21.1494 11.92 22.4244C12.0981 22.5178 12.296 22.5669 12.4971 22.5675C12.6982 22.5681 12.8964 22.5201 13.075 22.4277C15.5133 21.1661 18.455 19.4477 20.7967 17.1944C23.1467 14.9361 25 12.0311 25 8.42275C25 6.32275 24.3667 4.43441 23.1067 3.05441C21.835 1.66275 20.0233 0.899414 17.9 0.899414C16.1067 0.899414 14.6233 1.56441 13.495 2.81775C13.1093 3.25206 12.7754 3.72971 12.5 4.24108C12.2246 3.72971 11.8907 3.25206 11.505 2.81775C10.3767 1.56441 8.89333 0.901081 7.1 0.901081Z" fill="#7C8685" />
                            </svg>
                            <svg width="25" height="28" viewBox="0 0 25 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.6875 28C3.82812 28 3.09271 27.6956 2.48125 27.0869C1.86979 26.4781 1.56354 25.7455 1.5625 24.8889V4.66667H0V1.55556H7.8125V0H17.1875V1.55556H25V4.66667H23.4375V24.8889C23.4375 25.7444 23.1318 26.4771 22.5203 27.0869C21.9089 27.6967 21.1729 28.001 20.3125 28H4.6875ZM20.3125 4.66667H4.6875V24.8889H20.3125V4.66667ZM7.8125 21.7778H10.9375V7.77778H7.8125V21.7778ZM14.0625 21.7778H17.1875V7.77778H14.0625V21.7778Z" fill="#7C8685" />
                            </svg>
                        </div>
                    </div>
                </div>
        ...
        <section class="content2__search _container _container768 _container1200">
            <div class="text-mon20__bold _color-gradient display__none display__none800">РЕКОМЕНДАЦИИ</div>
            <div class="text-mon24__bold _color-gradient display__none320 display__flex display__none800">РЕКОМЕНДАЦИИ</div>
            <div class="text-mon32__bold _color-gradient display__none display__none320 display-flex800">РЕКОМЕНДАЦИИ</div>
            <div class="block-images__search">
                <div class="images__search"></div>
                <div class="images__search images2__search"></div>
                <div class="images__search images3__search"></div>
