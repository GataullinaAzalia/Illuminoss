...
<body>
    <div class="wrapper">
        ...
        <section class="content1__subscription _container  _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Отзывы</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Отзывы</div>
            <div class="text-mon48__bold _color-gradient display__none display__none320 display-flex800">Отзывы</div>
            <div class="block-content__subscription">
                <div class="card__reviews">
                    <div class="icon-text__reviews">
                        <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_30_258)">
                              <path d="M31.002 17.375C31.002 19.6128 30.113 21.7589 28.5307 23.3412C26.9483 24.9236 24.8022 25.8125 22.5645 25.8125C20.3267 25.8125 18.1806 24.9236 16.5982 23.3412C15.0159 21.7589 14.127 19.6128 14.127 17.375C14.127 15.1372 15.0159 12.9911 16.5982 11.4088C18.1806 9.82645 20.3267 8.9375 22.5645 8.9375C24.8022 8.9375 26.9483 9.82645 28.5307 11.4088C30.113 12.9911 31.002 15.1372 31.002 17.375Z" fill="#7C8685" />
                              <path fill-rule="evenodd" clip-rule="evenodd" d="M0.0644531 23C0.0644531 17.0326 2.43498 11.3097 6.65455 7.0901C10.8741 2.87053 16.5971 0.5 22.5645 0.5C28.5318 0.5 34.2548 2.87053 38.4744 7.0901C42.6939 11.3097 45.0645 17.0326 45.0645 23C45.0645 28.9674 42.6939 34.6903 38.4744 38.9099C34.2548 43.1295 28.5318 45.5 22.5645 45.5C16.5971 45.5 10.8741 43.1295 6.65455 38.9099C2.43498 34.6903 0.0644531 28.9674 0.0644531 23ZM22.5645 3.3125C18.857 3.3127 15.2249 4.35977 12.0862 6.3332C8.94756 8.30664 6.42994 11.1262 4.8231 14.4674C3.21627 17.8086 2.58554 21.5356 3.00351 25.2195C3.42148 28.9034 4.87116 32.3943 7.1857 35.2906C9.18258 32.0731 13.5785 28.625 22.5645 28.625C31.5504 28.625 35.9435 32.0703 37.9432 35.2906C40.2577 32.3943 41.7074 28.9034 42.1254 25.2195C42.5434 21.5356 41.9126 17.8086 40.3058 14.4674C38.699 11.1262 36.1813 8.30664 33.0427 6.3332C29.904 4.35977 26.272 3.3127 22.5645 3.3125Z" fill="#7C8685" />
                            </g>
                            <defs>
                              <clipPath id="clip0_30_258">
                                <rect width="45" height="45" fill="white" transform="translate(0.0644531 0.5)" />
                              </clipPath>
                            </defs>
                        </svg>
                        <div class="text-mon20__bold">Морозова Дарья Кирилловна</div>
                    </div>
                    <div class="text-mon12__reg">Очаровательная сумка Small Devotion Top-Handle Bag стала моим незаменимым аксессуаром в повседневной жизни. Ее стильный дизайн и качественные материалы создают великолепное сочетание комфорта и элегантности. Я очень довольна ее функциональностью...</div>
                </div>
                <div class="card__reviews">
                    <div class="icon-text__reviews">
                        <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section class="content2__search _container  _container768 _container1200">
            <div class="text-mon20__bold _color-gradient display__none display__none800">Новинки</div>
            <div class="text-mon24__bold _color-gradient display__none320 display__flex  display__none800">Новинки</div>
            <div class="text-mon32__bold _color-gradient display__none display__none320 display-flex800">Новинки</div>
            <div class="block-images__search">
                <div class="images__search"></div>
                <div class="images__search images2__search"></div>
                <div class="images__search images3__search"></div>
                <div class="images__search images4__search"></div>
            </div>
        </section>
        <div class="line  _container768 _container1200"></div>
