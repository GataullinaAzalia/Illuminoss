...
<body>
    <div class="wrapper">
        ...
        <section class="content2__search _container _container768 _container1200 __margin-top451">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Выбрать тариф</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Выбрать тариф</div>
            <div class="text-mon48__bold _color-gradient  display__none display__none320 display-flex800">Выбрать тариф</div>
            <div class="block-content__subscription">
                ...
                <div class="card-content__subscription">
                    ...
                    <div class="content-text__subscription">
                        ...
                        <button class="btn__subscription __margin-top45 " href="#" id="open_pop_up">
                            <div class="text-mon10__bold display__none display__none800">Подключить за 99 р./ месяц
                            </div>
                            <div class="text-mon16__bold display__none320 display__flex _color-white">Подключить за 99
                                р./ месяц</div>
            ...
            <div class="text-mon24__bold _color-gradient display__none display__none800">Выбрать банк</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Выбрать банк</div>
            <div class="text-mon48__bold _color-gradient  display__none display__none320 display-flex800">Выбрать банк</div>
            <div class="oplata">
                <a href="https://www.tbank.ru/mybank/payments/">
                    <div class="oplata__img"></div>
                </a>
                <a href="https://www.sberbank.com/ru/person/payments/qr_spb">
                    <div class="oplata__img _oplata__img2"></div>
                </a>
                <a href="https://uralsib.ru/online">
                    <div class="oplata__img _oplata__img3"></div>
                </a>
                <a href="https://www.vtb.ru/personal/online-servisy/platezhi/?ysclid=m3imhzjfjs537839259">
                    <div class="oplata__img _oplata__img4"></div>
                </a>
            </div>
        </section>
        <div class="line _container768 _container1200"></div>
