...
<body>
    <div class="wrapper">
        ...
        <section class="content__support _container _container768 _container1200">
            <div class="text-mon24__bold _color-gradient display__none display__none800">Изменение данных о фильме или сериале</div>
            <div class="text-mon36__bold _color-gradient display__none320 display__flex  display__none800">Изменение данных о фильме или сериале</div>
            <div class="text-mon48__bold _color-gradient display__none display__none320 display-flex800">Изменение данных о фильме или сериале</div>
            <form class="block-text__support _gap30"   action="assets/php/update_product.php"  method="POST" enctype="multipart/form-data">
                <div class="input-container ic1">
                    <input class="input" type="text" name="name" placeholder="Название фильма" value="<?= $product['name'] ?>" required>
                </div>
                <div class="input-container ic1">
                    <textarea class="input" name="briefdescription" placeholder="Краткое описание фильма" required><?= $product['briefdescription'] ?></textarea>
                </div>
                <div class="input-container ic1">
                    <textarea class="input" name="description" placeholder="Описание фильма" required><?= $product['description'] ?></textarea>
                </div>
                <div class="input-container ic1">
                    <textarea class="input" name="year" placeholder="Год производства" required><?= $product['year'] ?></textarea>
                </div>
                <div class="input-container ic1">
                    <label class="input" >
                ...
                <div class="input-container ic1">
                    <textarea class="input"  name="country" placeholder="Страна" required><?= $product['country'] ?></textarea>
                </div>
                ...
                <button class="btn__support __margin-top15 _w0" type="submit">
                <div class="text-mon15__bold display__none display__none800 ">Сохранить изменения</div>
                <div class="text-mon20__bold display__none320 display__flex _color-white">Сохранить изменения</div>
                </button>
            </form>
